function AlteraRele1(){
    ...
    if(estado === "0"){
		...
		document.getElementById("botao").innerHTML="<a href='/?desligar' class='botao'>Dicroica Sala</a>";
    } else {
        document.getElementById("estado").innerHTML="0";
        document.getElementById("rele").innerHTML="<div class='rele1_desligado'></div>";
        document.getElementById("botao").innerHTML="<a href='/?ligar' class='botao'>Dicroica Sala</a>";
    }
}
